// Search's reading mode (Reader.swift), run in the page on demand: the piece of the page with the most prose,
// punished for every link in it, laid out on its own. Returns 'read' or 'none'.
export const READER = `
(function () {
  function prose(el) {
  ...
  sheet.textContent = [
    ...
    '#leech-reader{max-width:38em;margin:0 auto;padding:72px 24px 160px;',
    'font:400 18px/1.72 serif;color:#171717}',
    '#leech-reader h1{font:600 30px/1.24 sans-serif;',
    'margin:0 0 8px;letter-spacing:-0.01em}',
    '#leech-reader .leech-from{font:400 12px/1 sans-serif;color:#a3a3a3;',
    'margin:0 0 40px;text-transform:uppercase;letter-spacing:.06em}',
    '#leech-reader p{margin:0 0 1.35em}',
    '#leech-reader img,#leech-reader video,#leech-reader iframe{max-width:100%;',
    'height:auto;border-radius:6px;margin:1.6em 0;display:block}',
    '#leech-reader iframe{width:100%;aspect-ratio:16/9;height:auto;border:0}',
    '#leech-reader figure{margin:1.8em 0}',
    '#leech-reader figcaption{font:400 13px/1.5 sans-serif;',
    'color:#a3a3a3;margin-top:.6em}',
    '#leech-reader a{color:#171717;text-underline-offset:3px}',
    '#leech-reader h2,#leech-reader h3{font:600 20px/1.3 sans-serif;',
    'margin:2em 0 .6em}',
    '#leech-reader pre,#leech-reader code{font-family:ui-monospace,monospace;font-size:14px}',
    '#leech-reader pre{background:#f5f5f5;padding:14px;border-radius:8px;overflow:auto}',
    '#leech-reader blockquote{margin:1.6em 0;padding-left:1.2em;',
    'border-left:2px solid #e8e8e8;color:#555}'
  ].join('');

  var wrap = document.createElement('div');
  wrap.id = 'leech-reader';
